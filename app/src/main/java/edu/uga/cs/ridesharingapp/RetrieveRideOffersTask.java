...
public class RetrieveRideOffersTask extends AsyncTask<Void, List<Ride>> {
    ...
    public RetrieveRideOffersTask(RideDataCallback callback) {
        this.callback = callback;
    }

    @Override
    protected List<Ride> doInBackground(Void... voids) {
        // This method doesn't actually fetch since Firebase is async; will return null.
        return null;
    }

    @Override
    protected void onPostExecute(List<Ride> result) {
        // Do nothing; real data is handled below.
    }
